...
- Name: specs/02-middleware.spec.ts >> /consent is NOT blocked when authenticated but missing consent cookie @stateless
- Location: e2e/specs/02-middleware.spec.ts:100:5
