...
- Name: specs/02-middleware.spec.ts >> unauthenticated user — public routes pass through @stateless >> GET /consent is NOT redirected to /login
- Location: e2e/specs/02-middleware.spec.ts:43:9
