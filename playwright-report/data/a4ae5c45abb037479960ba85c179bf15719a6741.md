    ...
    - banner [ref=e3]:
      - generic [ref=e4]:
        - link [ref=e5] [cursor=pointer]:
          - /url: /settings
          - img [ref=e6]
        - heading "이용약관" [level=1] [ref=e9]
    - main [ref=e10]:
      - paragraph [ref=e11]: 본 약관은 한국어로 작성되었습니다. For the English version, please see below.
      - generic [ref=e12]:
        - heading "서비스 이용약관 (한국어)" [level=2] [ref=e13]
        - paragraph [ref=e14]: "시행일: 2025년 1월 1일"
        - generic [ref=e15]:
          - generic [ref=e16]:
            - heading "제1조 (목적)" [level=3] [ref=e17]
            - paragraph [ref=e18]: 본 약관은 Plaque(이하 "서비스")가 제공하는 개인 미술 아카이브 서비스의 이용 조건 및 절차, 기타 필요한 사항을 규정함을 목적으로 합니다.
          - generic [ref=e19]:
            - heading "제2조 (서비스의 성격)" [level=3] [ref=e20]
            - paragraph [ref=e21]:
              - text: Plaque는 이용자가 전시장 및 미술관에서 직접 관람한 미술 작품의 사진과 메모를 기록·보관하는
              - strong [ref=e22]: 개인용 아카이브 서비스
              - text: 입니다. 본 서비스는 소셜 미디어 서비스가 아니며, 이용자의 콘텐츠는 외부에 공개되지 않습니다.
          - generic [ref=e23]:
            - heading "제3조 (저작권 및 이용 범위)" [level=3] [ref=e24]
            - paragraph [ref=e25]: 이용자는 본 서비스를 통해 미술 작품 사진을 기록할 때 다음 사항을 준수해야 합니다.
            - list [ref=e26]:
              - listitem [ref=e27]: 본인이 직접 관람한 작품에 한하여 사진을 기록할 수 있습니다.
              - listitem [ref=e28]:
                - text: 기록된 사진 및 정보는
                - strong [ref=e29]: 개인적인 사용 목적
                - text: (저작권법 제30조 사적이용을 위한 복제)에 한하여만 이용 가능합니다.
              - listitem [ref=e30]: 기록된 미술 작품 이미지를 상업적 목적으로 이용하는 것을 금지합니다.
              - listitem [ref=e31]: 이용자의 이미지는 해당 이용자 계정 내에서만 접근 가능하며 제3자와 공유되지 않습니다.
              - listitem [ref=e32]: 일부 미술관·전시장은 촬영을 금지하거나 제한할 수 있습니다. 이용자는 해당 공간의 촬영 정책을 반드시 확인하고 준수해야 하며, 이로 인한 분쟁에 대해Plaque는 책임을 지지 않습니다.
          - generic [ref=e33]:
            - heading "제4조 (계정 및 보안)" [level=3] [ref=e34]
            - paragraph [ref=e35]: 서비스는 Google OAuth를 통해 로그인합니다. 이용자는 본인 계정의 보안 유지에 책임이 있습니다. 계정 도용 등 보안 문제 발생 시 즉시 서비스에 알려주시기 바랍니다.
          - generic [ref=e36]:
            - heading "제5조 (서비스 변경 및 중단)" [level=3] [ref=e37]
            - paragraph [ref=e38]: Plaque는 서비스의 내용을 변경하거나 중단할 수 있습니다. 중요한 변경이 있을 경우 사전에 공지하며, 이용자의 데이터 내보내기 기회를 제공합니다.
          - generic [ref=e39]:
            - heading "제6조 (면책 조항)" [level=3] [ref=e40]
            - paragraph [ref=e41]: 본 서비스는 "있는 그대로(as-is)" 제공됩니다. Plaque는 서비스 이용으로 인한 데이터 손실, 이미지 손실에 대해 법적으로 허용되는 한도 내에서 책임을 제한합니다. 중요한 데이터는 별도로 백업하시기 바랍니다.
          - generic [ref=e42]:
            - heading "제7조 (준거법)" [level=3] [ref=e43]
            - paragraph [ref=e44]: 본 약관은 대한민국 법률에 따라 해석되며, 분쟁이 발생할 경우 대한민국 법원에 관할권이 있습니다.
      - generic [ref=e46]:
        - heading "Terms of Service (English)" [level=2] [ref=e47]
        - paragraph [ref=e48]: "Effective: 2025년 1월 1일"
        - generic [ref=e49]:
          - generic [ref=e50]:
            - heading "1. Purpose" [level=3] [ref=e51]
            - paragraph [ref=e52]: These Terms govern your use of Plaque, a personal art-archive service, and set out the rights and obligations of all users.
          - generic [ref=e53]:
            - heading "2. Nature of the Service" [level=3] [ref=e54]
            - paragraph [ref=e55]:
              - text: Plaque is a
              - strong [ref=e56]: personal-use archiving tool
          ...
          - generic [ref=e57]:
            - heading "3. Copyright and Permitted Use" [level=3] [ref=e58]
            - paragraph [ref=e59]: "When recording artwork images you agree to the following:"
            - list [ref=e60]:
              - listitem [ref=e61]: You may only record artworks you have personally viewed.
              - listitem [ref=e62]:
                - text: All recorded images and information are for
                - strong [ref=e63]: personal, non-commercial use only
              ...
              - listitem [ref=e64]: Commercial use of recorded images is strictly prohibited.
              - listitem [ref=e65]: Your images are accessible only within your own account and are never shared with third parties.
              - listitem [ref=e66]: Some venues prohibit photography. You are solely responsible for complying with venue policies; Plaque bears no liability for violations.
          - generic [ref=e67]:
            - heading "4. Accounts and Security" [level=3] [ref=e68]
            - paragraph [ref=e69]: The service uses Google OAuth for authentication. You are responsible for maintaining the security of your account. Please notify us immediately of any unauthorised access.
          - generic [ref=e70]:
            - heading "5. Service Changes and Termination" [level=3] [ref=e71]
            - paragraph [ref=e72]: We may modify or discontinue the service. For significant changes we will give advance notice and offer a data-export opportunity.
          - generic [ref=e73]:
            - heading "6. Disclaimer" [level=3] [ref=e74]
            - paragraph [ref=e75]: The service is provided "as is". To the extent permitted by law, Plaque limits its liability for data loss or service interruptions. Please back up any data you consider important.
          - generic [ref=e76]:
            - heading "7. Governing Law" [level=3] [ref=e77]
            - paragraph [ref=e78]: These Terms are governed by the laws of the Republic of Korea. Disputes shall be resolved in Korean courts. Users outside Korea may also have rights under local consumer-protection laws that these Terms do not override.
      - generic [ref=e79]:
        - link "개인정보처리방침 · Privacy Policy" [ref=e80] [cursor=pointer]:
          - /url: /privacy
        - link "설정으로 돌아가기" [ref=e81] [cursor=pointer]:
          - /url: /settings
